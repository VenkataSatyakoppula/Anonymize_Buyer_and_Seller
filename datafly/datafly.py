...
class _Table:
    ...
    # Writes a k-anonymous representation of this table on a new file. The maximum number of suppressed rows is k.
    ...
    # Prints a log message. Take content to be logged as parameter
    @staticmethod
    ...
    # Prints a debug message. Take content to be printed as parameter
    @staticmethod
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i, qi_name in enumerate(args.quasi_identifier):
            # mapping QI name with corresponding DGH file
        ...
        _Table._log("[LOG] Done in %.2f seconds" %
                    (end), endl=True, enabled=True)
